...
const GET_PRODUCTS = gql`
  query getProducts($type: CategoryType!, $color: String!, $priceMax: Int!, $priceMin: Int!, $sortBy: ProductSort, $indexFrom: Int!, $limit: Int!, ) {
    products(type: $type, color: $color, priceMax: $priceMax, priceMin: $priceMin, sortBy: $sortBy, indexFrom: $indexFrom, limit: $limit,) {
      total
      hasMore
      items {
        id
