...
const banners = [
  {
    ...
    title1: "gran liquidación",
    title2: "electrodomésticos",
    subTitle: "50% de descuento en productos seleccionados",
    category: "ELECTRÓNICA",
    btn: "Comprar ahora",
  },
  {
    img1: "/images/layout-5/slider/1.2.png",
    title1: "grandes marcas, grandes rebajas",
    title2: "refrigeración",
    subTitle: "30% de descuento en productos seleccionados",
    category: "ELECTRÓNICA",
    btn: "Comprar ahora",
  },
  {
    img1: "/images/layout-5/slider/1.1.png",
    title1: "la mejor oferta de hoy",
    title2: "aparatos electrónicos",
    subTitle: "40% de descuento en productos seleccionados",
    category: "ELECTRÓNICA",
    btn: "Comprar ahora",
  },
];
