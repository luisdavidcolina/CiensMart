...
const RatioSquare: NextPage = () => {
  ...
  const clickProductDetail = (item: any) => {
                                      ...
                                      <div>
                                        <div className="product-detail">
                                          ...
                                          <h6>
                                            ...
                                            {item.price && typeof item.price === "number" && item.discount && typeof item.discount === "number" ? ((item.price - item.price * (item.discount / 100)) * selectedCurr.value).toFixed(2) : 0}
                                            <span>
                                              {selectedCurr.symbol}
                                              {/* {(item.price * selectedCurr.value).toFixed(2)} */}
                                              {typeof item.price === "number" && typeof item.discount === "number" ? ((+item.price - +item.price * (item.discount / 100)) * selectedCurr.value).toFixed(2) : "0"}
                                            </span>
                                          </h6>
                                        </div>
                                  ...
                                  <div className="media-body">
                                    <div className="media-contant">
                                      <div>
                                        ...
                                        <a href={`/product-details/${item.id}-${typeof item.title === "string" ? item.title.split(" ").join("") : ""}`}>
                                          <p>{item.title}</p>
                                        </a>
                                        <h6>
                                          {selectedCurr.symbol}
