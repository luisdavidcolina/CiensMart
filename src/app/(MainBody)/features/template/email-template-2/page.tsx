                        ...
                        <tr>
                          ...
                          <td align="center" style={{ backgroundColor: "#fafafa", width: "60%" }}>
                            ...
                            <div style={{ color: "#E01931", fontWeight: "normal", fontSize: "16px", lineHeight: "27px", letterSpacing: "1px", margin: "4px" }}>
                              <span style={{ color: "#666666", fontWeight: "normal", fontSize: "15px", lineHeight: "25px", letterSpacing: "1px;" }} className="txt-price1" data-color="Price1" data-size="Price1" data-min="10" data-max="35">
                                $25.00
                              </span>
                      ...
                      <tbody>
                        <tr>
                          <td align="center" style={{ backgroundColor: "#fafafa", width: "60%" }}>
                            <h3 style={{ margin: "0" }}>Product One</h3>
                            <div style={{ color: "#E01931", fontWeight: "normal", fontSize: "16px", lineHeight: "27px", letterSpacing: "1px", margin: "4px" }}>
                              <span style={{ color: "#666666", fontSize: "15px", lineHeight: "25px", letterSpacing: "1px" }} className="txt-price1" data-color="Price1" data-size="Price1" data-min="10" data-ax="35">
                                $25.00
                              </span>
                              <span className="txt-price2">&nbsp;&nbsp;&nbsp;</span>$20.90
                            </div>
                        ...
                        <tr>
                          ...
                          <td align="center" style={{ backgroundColor: "#fafafa", width: "60%" }}>
                            ...
                            <div style={{ color: "#E01931", fontSize: "16px", lineHeight: "27px", letterSpacing: "1px", margin: "4px" }}>
                              <span style={{ color: "#666666", fontSize: "15px", lineHeight: "25px", letterSpacing: "1px;" }} className="txt-price1" data-color="Price1" data-size="Price1" data-min="10" data-max="35">
                                $25.00
                              </span>
                              <span className="txt-price2">&nbsp;&nbsp;&nbsp;</span>$20.90
                            </div>
